...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create()
        {
            ...
            hangsanxuats = db.Hangsanxuats.ToList();
            List<Hedieuhanh> hedieuhanhs = new List<Hedieuhanh>();
            hangsanxuats = db.Hangsanxuats.ToList();
            hedieuhanhs = db.Hedieuhanhs.ToList();
            sp.HeDhCollection = hedieuhanhs;
            sp.HangCollection = hangsanxuats;
            return View(sp);
        }
